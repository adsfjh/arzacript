...
addbtnscript('guide hide',"Приложите информацию используя модуль 'Дополнительно' -> Скрыть -> Скрытый текст для определенных групп -> Ставите галочку правее от 'Тех. Администратор' в графу текст вставьте ссылку или запрашиваемую информацию<br><br>[IMG]https://imgur.com/a/c3wmhRo[/IMG].");
