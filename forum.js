...
addbtnscript('Предложение/баг',"[CENTER][FONT=verdana]Приветствую.<br>Заполните один раз эту форму - [URL='https://vk.cc/9oXahr'][SIZE=4][I][COLOR=rgb(226, 80, 65)]кликабельно.[/COLOR][/I][/SIZE][/URL]<br>После этого ваша заявка будет на рассмотрении у разработчиков. <br>Обратите внимание, что обратного ответа в этой теме не будет.<br>Закрыто.[/FONT][/CENTER]");
